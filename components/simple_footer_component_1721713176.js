...
*/
Vue.component("simple_footer_component_1721713176", {
    template: `
                ...
                <div id="footer-content" class="text-center">
                    <div class="flex">
                        <a id="footer-logo-link" href="#" class="flex-1 flex items-center justify-center mb-5 text-2xl font-semibold text-gray-900 dark:text-white">
                            ...
                            DappTrace - Ethereum Transaction Explorer
                        </a>
                    </div>
                </div>
                <div class="flex">
                    <div id="footer-text" class="flex-1 block text-sm text-center text-gray-500 dark:text-gray-400">
                        Stay ahead of the latest Ethereum activity with DappTrace. Our platform monitors the Ethereum blockchain in real-time, alerting you to new transactions as they occur. Never miss a beat with transparent and reliable on-chain data.
                    </div>
                </div>
            </div>
        </footer> 
